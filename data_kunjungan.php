        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
          <!-- <div class="modal-dialog" role="document"> -->
            <div class="modal-content">
              <div class="modal-header border-0">
                <h5 class="modal-title">
                  <span class="fw-mediumbold" id="modalTitle"></span>
                </h5>
                <button
                type="button"
                class="close"
            ...
            <div class="modal-body">
              <form id="formInputDataKunjungan" onsubmit="event.preventDefault();">
                <div class="row">
                   <input type="hidden" name="kunjungan_id" id="kunjungan_id">
              <div class="col-sm-12">
                    <div class="form-group">
                          <label>Nama Pasien</label>
                          <select class="form-select form-control" name="nama_pasien" id="nama_pasien">
        <option value="">-- Nama Pasien --</option>
              ...
              <div class="col-sm-12">
                    <div class="form-group">
                          ...
                          <select class="form-select form-control" name="nama_dokter" id="nama_dokter">
...
<div class="table-responsive">
  ...
  <tbody id="data-kunjungan-list"></tbody>
</table>
</div>
</div>
</div>

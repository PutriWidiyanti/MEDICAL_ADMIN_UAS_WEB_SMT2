        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
          <!-- <div class="modal-dialog" role="document"> -->
            ...
            <div class="modal-body">
              <form id="formInputDataDokter" onsubmit="event.preventDefault();">
                <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <input
                  name="nomor_izin_praktik"
                  id="nomor_izin_praktik"
                  type="text"
                  class="form-control"
...
<div class="table-responsive">
  ...
  <tbody id="data-dokter-list"></tbody>
</table>
</div>
</div>
</div>
